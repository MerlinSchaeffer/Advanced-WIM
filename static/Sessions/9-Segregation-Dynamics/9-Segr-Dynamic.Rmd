...
.font70[
```{r}
rbinom(n = 44, size = 1, prob = 0.5)
```
]
2. Decide who plays heads and who plays tails.
3. A Neighborhood is defined as $\pm 3 \rightarrow$ 1 0 1 **1** 0 0 0.
4. A dissatisfied actor moves to the nearest position where she would be satisfied and squeezes in.
5. Define *silently for yourself*, how many neighbors shall at least be of your group (1+, 2+, 3+, etc.).
6. Take turns until every actor is satisfied.
7. How many of your actors live more segregated than the minimum rule demands?
]


---

<iframe src='http://nifty.stanford.edu/2014/mccown-schelling-model-segregation/' width='800' height='600' frameborder='0' scrolling='yes'></iframe>
...
Thus, go through the text. Which insights did you find important and why? 
]]
...
.push-left[
<iframe src='http://nifty.stanford.edu/2014/mccown-schelling-model-segregation/' width='800' height='550' frameborder='0' scrolling='yes'></iframe>
]
