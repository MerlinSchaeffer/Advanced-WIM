...
- (ii) Køber/**Receiver only benefits, if** Mægler/**Signaler can be trusted** that the house has quality $k$ (no rot under the roof).

- If house has $k$, Mægler's and Køber's interest are aligned (both benefit). If $\text{non-}k$, Køber may be deceived (Only Signaler benefits).
]
...
```
.center[.backgrnote[*Source*: `r Citet(myBib, "spence_job_1973")`]]
]
...
.right-column[
<iframe src="https://ourworldindata.org/grapher/share-of-the-population-with-completed-tertiary-education?time=2010" loading="lazy" style="width: 100%; height: 600px; border: 0px none;"></iframe>
]
...
|                          Topic 1 | Topic 2 |
-------------------------|---------|---------|
'Wasting' signs/signals  | Group 1 | Group 4 |
Costless signs/signals   | Group 2 | Group 5 |
Receivers                | Group 3 | Group 6 |
